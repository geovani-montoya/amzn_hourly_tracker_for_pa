...
Sub hour8()
    ...
    For dtDate = dtStartDate To dtEndDate
        ...
        Call import8("ppr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import8("pid", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import8("frr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import8("ur", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
...
Sub import8(dataBase As String, refIter As String, dtDate, building)
'''' THIS SUB MAKES SURE THE RIGHT WORKSHEETS ARE PRESENT OR CREATES THEM'''
    ...
    Set arrWs = Sheets(Array("ppr9", "pid9", "frr9", "ur9"))
    ...
    Call websiteDictionaryIntraday(dataBase, refIter, dtDate, building, "14", "15")
