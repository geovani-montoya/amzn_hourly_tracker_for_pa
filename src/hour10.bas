...
Sub hour10()
    ...
    For dtDate = dtStartDate To dtEndDate
        ...
        Call import10("ppr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import10("pid", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import10("frr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import10("ur", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
...
Sub import10(dataBase As String, refIter As String, dtDate, building)
'''' THIS SUB MAKES SURE THE RIGHT WORKSHEETS ARE PRESENT OR CREATES THEM'''
    ...
    Set arrWs = Sheets(Array("ppr11", "pid11", "frr11", "ur11"))
    ...
    Call websiteDictionaryIntraday(dataBase, refIter, dtDate, building, "16", "17")
