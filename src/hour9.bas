...
Sub hour9()
    ...
    For dtDate = dtStartDate To dtEndDate
        ...
        Call import9("ppr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import9("pid", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import9("frr", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
        Call import9("ur", stIter, dtDate, building)
        Application.Wait (Now + TimeValue("0:00:01"))
...
Sub import9(dataBase As String, refIter As String, dtDate, building)
'''' THIS SUB MAKES SURE THE RIGHT WORKSHEETS ARE PRESENT OR CREATES THEM'''
    ...
    Set arrWs = Sheets(Array("ppr10", "pid10", "frr10", "ur10"))
    ...
    Call websiteDictionaryIntraday(dataBase, refIter, dtDate, building, "15", "16")
